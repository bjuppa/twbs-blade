{{-- TODO: add validation state classes to form-group --}}
...
<div class="form-group">
	...
	@yield($bsb_pkg_ref.'_form_control_or_group') {{-- This section can be a single .form-control or one wrapped in .input-group --}}
	{{-- TODO: add optional form-control-feedback icon just after form control/group --}}

	{{-- TODO: close the 2nd column div here if the description should go in it's own column. Also supply the description with a col width --}}
	@if(true) {{-- TODO: only display if there is help text or error messages for the field --}}
